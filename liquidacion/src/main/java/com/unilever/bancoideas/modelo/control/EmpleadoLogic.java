    ...
    */
    ...
    public void saveEmpleado(Empleado entity) throws Exception {
        ...
        try {
            ...
            if (entity.getFechaIncio() == null) {
                throw new ZMessManager().new EmptyFieldException("fechaIncio");
            }
    ...
    public List<EmpleadoDTO> getDataEmpleado() throws Exception {
        try {
            ...
            for (Empleado empleadoTmp : empleado) {
                ...
                empleadoDTO2.setCodigo((empleadoTmp.getCodigo() != null)
                    ? empleadoTmp.getCodigo() : null);
                empleadoDTO2.setEstadoRegistro((empleadoTmp.getEstadoRegistro() != null)
                    ? empleadoTmp.getEstadoRegistro() : null);
                empleadoDTO2.setFechaCreacion(empleadoTmp.getFechaCreacion());
                empleadoDTO2.setFechaFin(empleadoTmp.getFechaFin());
                empleadoDTO2.setFechaIncio(empleadoTmp.getFechaIncio());
                empleadoDTO2.setFechaModificacion(empleadoTmp.getFechaModificacion());
                empleadoDTO2.setUsuCreador((empleadoTmp.getUsuCreador() != null)
                    ? empleadoTmp.getUsuCreador() : null);
                empleadoDTO2.setUsuModifica((empleadoTmp.getUsuModifica() != null)
                    ? empleadoTmp.getUsuModifica() : null);
                empleadoDTO2.setCargId_Cargo((empleadoTmp.getCargo().getCargId() != null)
                    ? empleadoTmp.getCargo().getCargId() : null);
                empleadoDTO2.setPersId_Persona((empleadoTmp.getPersona()
                                                           .getPersId() != null)
                    ? empleadoTmp.getPersona().getPersId() : null);
