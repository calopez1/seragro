    ...
    public List<UsuarioDTO> getDataUsuario() throws Exception {
        try {
            ...
            for (Usuario usuarioTmp : usuario) {
                ...
                usuarioDTO2.setEstadoRegistro((usuarioTmp.getEstadoRegistro() != null)
                    ? usuarioTmp.getEstadoRegistro() : null);
                ...
                usuarioDTO2.setUsuModifica((usuarioTmp.getUsuModifica() != null)
                    ? usuarioTmp.getUsuModifica() : null);
                usuarioDTO2.setUsuario((usuarioTmp.getUsuario() != null)
                    ? usuarioTmp.getUsuario() : null);
                usuarioDTO2.setDepaId_Departamento((usuarioTmp.getDepartamento()
                                                              .getDepaId() != null)
                    ? usuarioTmp.getDepartamento().getDepaId() : null);
                usuarioDTO2.setPersId_Persona((usuarioTmp.getPersona()
                                                         .getPersId() != null)
                    ? usuarioTmp.getPersona().getPersId() : null);
                usuarioDTO2.setTiusId_TipoUsuario((usuarioTmp.getTipoUsuario()
                                                             .getTiusId() != null)
