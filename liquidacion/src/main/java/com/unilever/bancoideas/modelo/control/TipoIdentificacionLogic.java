...
public class TipoIdentificacionLogic implements ITipoIdentificacionLogic {
    private static final Logger log = LoggerFactory.getLogger(TipoIdentificacionLogic.class);
    ...
    */
    ...
    public void deleteTipoIdentificacion(TipoIdentificacion entity)
        ...
        try {
            personas = personaDAO.findByProperty("tipoIdentificacion.tiidId",
                    entity.getTiidId());
    ...
    public List<TipoIdentificacionDTO> getDataTipoIdentificacion()
        throws Exception {
        try {
            List<TipoIdentificacion> tipoIdentificacion = tipoIdentificacionDAO.findAll();
            ...
            for (TipoIdentificacion tipoIdentificacionTmp : tipoIdentificacion) {
                ...
                tipoIdentificacionDTO2.setTiidId(tipoIdentificacionTmp.getTiidId());
                tipoIdentificacionDTO2.setCodigo((tipoIdentificacionTmp.getCodigo() != null)
                    ? tipoIdentificacionTmp.getCodigo() : null);
                tipoIdentificacionDTO2.setEstadoRegistro((tipoIdentificacionTmp.getEstadoRegistro() != null)
                    ? tipoIdentificacionTmp.getEstadoRegistro() : null);
                tipoIdentificacionDTO2.setFechaCreacion(tipoIdentificacionTmp.getFechaCreacion());
                tipoIdentificacionDTO2.setFechaModificacion(tipoIdentificacionTmp.getFechaModificacion());
                tipoIdentificacionDTO2.setNombre((tipoIdentificacionTmp.getNombre() != null)
                    ? tipoIdentificacionTmp.getNombre() : null);
                tipoIdentificacionDTO2.setUsuCreador((tipoIdentificacionTmp.getUsuCreador() != null)
                    ? tipoIdentificacionTmp.getUsuCreador() : null);
                tipoIdentificacionDTO2.setUsuModificador((tipoIdentificacionTmp.getUsuModificador() != null)
                    ? tipoIdentificacionTmp.getUsuModificador() : null);
    ...
    public TipoIdentificacion getTipoIdentificacion(Integer tiidId)
        ...
        try {
            entity = tipoIdentificacionDAO.findById(tiidId);
        } catch (Exception e) {
