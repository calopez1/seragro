    ...
    */
    ...
    public void savePersona(Persona entity) throws Exception {
        ...
        try {
            ...
            if ((entity.getPrimerApellido() != null) &&
                    (Utilities.checkWordAndCheckWithlength(
                        entity.getPrimerApellido(), 255) == false)) {
                throw new ZMessManager().new NotValidFormatException(
                    "primerApellido");
            }
            ...
            if ((entity.getPrimerNombre() != null) &&
                    (Utilities.checkWordAndCheckWithlength(
                        entity.getPrimerNombre(), 255) == false)) {
                throw new ZMessManager().new NotValidFormatException(
                    "primerNombre");
            }
            ...
            if ((entity.getSegundoApellido() != null) &&
                    (Utilities.checkWordAndCheckWithlength(
                        entity.getSegundoApellido(), 255) == false)) {
                throw new ZMessManager().new NotValidFormatException(
                    "segundoApellido");
            }
            ...
            if ((entity.getSegundoNombre() != null) &&
                    (Utilities.checkWordAndCheckWithlength(
                        entity.getSegundoNombre(), 255) == false)) {
                throw new ZMessManager().new NotValidFormatException(
                    "segundoNombre");
            }
            ...
            if (entity.getTipoIdentificacion().getTiidId() == null) {
                throw new ZMessManager().new EmptyFieldException(
    ...
    public void deletePersona(Persona entity) throws Exception {
        ...
        try {
            empleados = empleadoDAO.findByProperty("persona.persId",
                    entity.getPersId());
            ...
            usuarios = usuarioDAO.findByProperty("persona.persId",
                    entity.getPersId());
    ...
    public List<PersonaDTO> getDataPersona() throws Exception {
        try {
            ...
            for (Persona personaTmp : persona) {
                ...
                personaDTO2.setPersId(personaTmp.getPersId());
                personaDTO2.setEmail((personaTmp.getEmail() != null)
                    ? personaTmp.getEmail() : null);
                personaDTO2.setEstadoRegistro((personaTmp.getEstadoRegistro() != null)
                    ? personaTmp.getEstadoRegistro() : null);
                personaDTO2.setFechaCreacion(personaTmp.getFechaCreacion());
                personaDTO2.setFechaModificacion(personaTmp.getFechaModificacion());
                personaDTO2.setIdentificacion((personaTmp.getIdentificacion() != null)
                    ? personaTmp.getIdentificacion() : null);
                personaDTO2.setPrimerApellido((personaTmp.getPrimerApellido() != null)
                    ? personaTmp.getPrimerApellido() : null);
                personaDTO2.setPrimerNombre((personaTmp.getPrimerNombre() != null)
                    ? personaTmp.getPrimerNombre() : null);
                personaDTO2.setSegundoApellido((personaTmp.getSegundoApellido() != null)
                    ? personaTmp.getSegundoApellido() : null);
                personaDTO2.setSegundoNombre((personaTmp.getSegundoNombre() != null)
                    ? personaTmp.getSegundoNombre() : null);
                personaDTO2.setUsuCreador((personaTmp.getUsuCreador() != null)
                    ? personaTmp.getUsuCreador() : null);
                personaDTO2.setUsuModifica((personaTmp.getUsuModifica() != null)
                    ? personaTmp.getUsuModifica() : null);
                personaDTO2.setTiidId_TipoIdentificacion((personaTmp.getTipoIdentificacion()
                                                                    .getTiidId() != null)
                    ? personaTmp.getTipoIdentificacion().getTiidId() : null);
    ...
    public Persona getPersona(Integer persId) throws Exception {
        ...
        try {
            entity = personaDAO.findById(persId);
        } catch (Exception e) {
