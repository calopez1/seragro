...
public class CargoLogic implements ICargoLogic {
    ...
    */
        ...
        try {
            ...
            if ((entity.getAuxilioAlimentacion() != null) &&
                    (Utilities.checkWordAndCheckWithlength(
                        entity.getAuxilioAlimentacion(), 1) == false)) {
            ...
            if ((entity.getAuxilioTransporte() != null) &&
                    (Utilities.checkWordAndCheckWithlength(
                        entity.getAuxilioTransporte(), 1) == false)) {
                throw new ZMessManager().new NotValidFormatException(
                    "auxilioTransporte");
            }

            if (entity.getCargId() == null) {
                throw new ZMessManager().new EmptyFieldException("cargId");
            }
            ...
            if (entity.getSalario() == null) {
                throw new ZMessManager().new EmptyFieldException("salario");
            }

            if ((entity.getSalario() != null) &&
                    (Utilities.checkNumberAndCheckWithPrecisionAndScale("" +
                        entity.getSalario(), 14, 0) == false)) {
                throw new ZMessManager().new NotValidFormatException("salario");
            }
            ...
            if ((entity.getUsuModificacion() != null) &&
                    (Utilities.checkWordAndCheckWithlength(
                        entity.getUsuModificacion(), 100) == false)) {
                throw new ZMessManager().new NotValidFormatException(
                    "usuModificacion");
            }

            if (getCargo(entity.getCargId()) != null) {
    ...
    public void deleteCargo(Cargo entity) throws Exception {
        ...
        try {
            empleados = empleadoDAO.findByProperty("cargo.cargId",
                    entity.getCargId());
    ...
    public List<CargoDTO> getDataCargo() throws Exception {
        try {
            ...
            for (Cargo cargoTmp : cargo) {
                ...
                cargoDTO2.setCargId(cargoTmp.getCargId());
                cargoDTO2.setAuxilioAlimentacion((cargoTmp.getAuxilioAlimentacion() != null)
                    ? cargoTmp.getAuxilioAlimentacion() : null);
                cargoDTO2.setAuxilioTransporte((cargoTmp.getAuxilioTransporte() != null)
                    ? cargoTmp.getAuxilioTransporte() : null);
                cargoDTO2.setCodigo((cargoTmp.getCodigo() != null)
                    ? cargoTmp.getCodigo() : null);
                cargoDTO2.setEstadoRegistro((cargoTmp.getEstadoRegistro() != null)
                    ? cargoTmp.getEstadoRegistro() : null);
                cargoDTO2.setFechaCreacion(cargoTmp.getFechaCreacion());
                cargoDTO2.setFechaModificacion(cargoTmp.getFechaModificacion());
                cargoDTO2.setNombre((cargoTmp.getNombre() != null)
                    ? cargoTmp.getNombre() : null);
                cargoDTO2.setSalario((cargoTmp.getSalario() != null)
                    ? cargoTmp.getSalario() : null);
                cargoDTO2.setUsuCreador((cargoTmp.getUsuCreador() != null)
                    ? cargoTmp.getUsuCreador() : null);
                cargoDTO2.setUsuModificacion((cargoTmp.getUsuModificacion() != null)
                    ? cargoTmp.getUsuModificacion() : null);
    ...
    public Cargo getCargo(Integer cargId) throws Exception {
        ...
        try {
            entity = cargoDAO.findById(cargId);
        } catch (Exception e) {
