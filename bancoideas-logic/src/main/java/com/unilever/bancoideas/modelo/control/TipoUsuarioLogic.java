...
//            }
        	...
        	List<TipoUsuario> lstTipoUsuario = findByCriteria(variables, null, null);

        	if(lstTipoUsuario!= null && !lstTipoUsuario.isEmpty()) {
        		throw new Exception("Ya existe un rol con código: "+ entity.getCodigo());
        	}
    ...
    public List<TipoUsuarioDTO> getDataTipoUsuario() throws Exception {
        try {
            ...
            for (TipoUsuario tipoUsuarioTmp : tipoUsuario) {
                ...
                tipoUsuarioDTO2.setCodigo((tipoUsuarioTmp.getCodigo() != null)
                    ? tipoUsuarioTmp.getCodigo() : null);
                tipoUsuarioDTO2.setDescripcion((tipoUsuarioTmp.getDescripcion() != null)
                    ? tipoUsuarioTmp.getDescripcion() : null);
                tipoUsuarioDTO2.setEstadoRegistro((tipoUsuarioTmp.getEstadoRegistro() != null)
                    ? tipoUsuarioTmp.getEstadoRegistro() : null);
                tipoUsuarioDTO2.setFechaCreacion(tipoUsuarioTmp.getFechaCreacion());
                tipoUsuarioDTO2.setFechaModificacion(tipoUsuarioTmp.getFechaModificacion());
                tipoUsuarioDTO2.setNombre((tipoUsuarioTmp.getNombre() != null)
                    ? tipoUsuarioTmp.getNombre() : null);
                tipoUsuarioDTO2.setUsuCreador((tipoUsuarioTmp.getUsuCreador() != null)
                    ? tipoUsuarioTmp.getUsuCreador() : null);
                tipoUsuarioDTO2.setUsuModifica((tipoUsuarioTmp.getUsuModifica() != null)
                    ? tipoUsuarioTmp.getUsuModifica() : null);
