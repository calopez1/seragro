    ...
    */
    ...
    public void saveLiquidacionHoraExtra(LiquidacionHoraExtra entity)
        ...
        try {
            ...
            if (entity.getTotalPagarHorasExtras() == null) {
                throw new ZMessManager().new EmptyFieldException(
                    "totalPagarHorasExtras");
            }

            if (entity.getTotalPagarRecargo() == null) {
                throw new ZMessManager().new EmptyFieldException(
                    "totalPagarRecargo");
            }
            ...
            if (entity.getValorHoraExtra() == null) {
                throw new ZMessManager().new EmptyFieldException(
                    "valorHoraExtra");
            }

            if (entity.getValorRecargo() == null) {
                throw new ZMessManager().new EmptyFieldException("valorRecargo");
            }
            ...
            if (getLiquidacionHoraExtra(entity.getLhoeId()) != null) {
    ...
    public List<LiquidacionHoraExtraDTO> getDataLiquidacionHoraExtra()
        ...
        try {
            ...
            for (LiquidacionHoraExtra liquidacionHoraExtraTmp : liquidacionHoraExtra) {
                ...
                liquidacionHoraExtraDTO2.setFecha(liquidacionHoraExtraTmp.getFecha());
                ...
                liquidacionHoraExtraDTO2.setHorasTrabajadas((liquidacionHoraExtraTmp.getHorasTrabajadas() != null)
                    ? liquidacionHoraExtraTmp.getHorasTrabajadas() : null);
                liquidacionHoraExtraDTO2.setTotalPagarHorasExtras((liquidacionHoraExtraTmp.getTotalPagarHorasExtras() != null)
                    ? liquidacionHoraExtraTmp.getTotalPagarHorasExtras() : null);
                liquidacionHoraExtraDTO2.setTotalPagarRecargo((liquidacionHoraExtraTmp.getTotalPagarRecargo() != null)
                    ? liquidacionHoraExtraTmp.getTotalPagarRecargo() : null);
                ...
                liquidacionHoraExtraDTO2.setValorHoraExtra((liquidacionHoraExtraTmp.getValorHoraExtra() != null)
                    ? liquidacionHoraExtraTmp.getValorHoraExtra() : null);
                liquidacionHoraExtraDTO2.setValorRecargo((liquidacionHoraExtraTmp.getValorRecargo() != null)
                    ? liquidacionHoraExtraTmp.getValorRecargo() : null);
                liquidacionHoraExtraDTO2.setNoemId_NominaEmpleado((liquidacionHoraExtraTmp.getNominaEmpleado()
                    ...
                    : null);
                liquidacionHoraExtraDTO2.setThoeId_TipoHoraExtra((liquidacionHoraExtraTmp.getTipoHoraExtra()
                                                                                         .getThoeId() != null)
                    ? liquidacionHoraExtraTmp.getTipoHoraExtra().getThoeId()
                    : null);
